...
<body class="layout-login">
    ...
    <div class="layout-login__form bg-white" data-perfect-scrollbar>
        ...
        <form action="<c:url value="<%=Path.LOGIN %>" />" method="post">
            ...
            <div class="form-group text-center">
                ...
                <a href="<c:url value="<%=Path.FORGOT_PASSWORD %>" />" >Forgot password?</a> <br> Don't have an account? <a class="text-body text-underline" href="<c:url value="<%=Path.SIGNUP %>" />">Sign up!</a>
            </div>
        </form>
    </div>
