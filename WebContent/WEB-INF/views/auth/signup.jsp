...
<body class="layout-login">
	...
	<div class="layout-login__form bg-white" data-perfect-scrollbar>
		...
		<form action="<%=request.getContextPath() + Path.SIGNUP%>"
			...
			<div class="form-group">
				...
				<div class="input-group input-group-merge">
					<input id="name_2" type="text" name="username" required=""
			...
			<div class="form-group text-center">
				<button class="btn btn-primary mb-2" type="submit">Create
					Account</button>
				<br> <a class="text-body text-underline" href="login.html">Have
					an account? Login</a>
			</div>
		</form>
	</div>
