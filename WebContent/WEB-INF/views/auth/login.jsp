...
<!-- Perfect Scrollbar -->
<link type="text/css" href="<c:url value = "assets/vendor/perfect-scrollbar.css"/>"
	rel="stylesheet">
...
<link type="text/css" href="<c:url value = "assets/css/vendor-material-icons.css"/>"
	rel="stylesheet">
<link type="text/css" href="<c:url value = "assets/css/vendor-material-icons.rtl.css"/>"
	rel="stylesheet">

<!-- Font Awesome FREE Icons -->
<link type="text/css" href= "<c:url value = "assets/css/vendor-fontawesome-free.css"/>"
	rel="stylesheet">
<link type="text/css" href="<c:url value = "assets/css/vendor-fontawesome-free.rtl.css" />"
	rel="stylesheet">
</head>
...
<body class="layout-login">
	...
	<div class="layout-login__form bg-white" data-perfect-scrollbar>
		...
		<form action="<%=request.getContextPath() + Path.LOGIN %>" method = "post" novalidate>
			...
			<div class="form-group">
				...
				<div class="input-group input-group-merge">
					<input id="email_2" type="text" name ="username" required 
			...
			<div class="form-group text-center">
				...
				account? <a class="text-body text-underline" href="<%=request.getContextPath() + Path.SIGNUP%>">Sign
					up!</a>
			</div>
		</form>
	</div>
