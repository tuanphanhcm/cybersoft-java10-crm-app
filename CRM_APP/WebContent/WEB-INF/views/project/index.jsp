        ...
        <div id="admin-wrapper">
            ...
            <section id="admin-content" class="p-3">
                ...
                <table class="table table-bordered table-hover mt-3">
                    ...
                    <tbody>
                    	<c:forEach items="${listProjects }" var = "item">
                        <tr>
                            <td>${item.id }</td>
                            <td>${item.name }</td>
                            ...
                            <td>${item.userName }</td>
                            <td>
                                <a href="<%=request.getContextPath() %>/project/edit?id=${item.id}" class="btn btn-sm btn-info">
                                    <i class="fa fa-pencil-square-o"></i>
                                </a>
                                <a href="<%=request.getContextPath() %>/project/delete?id_delete=${item.id}" class="btn btn-sm btn-danger">
