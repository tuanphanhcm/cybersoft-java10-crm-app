                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" value="${user.passWord }" class="form-control" placeholder="password" readonly="readonly"/>
                            </div>
                            <div class="form-group">
                                <label>Họ tên</label>
                                <input type="text" name="fullname" value="${user.fullName }" class="form-control" placeholder="fullname" readonly="readonly"/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="roleid">
									<c:forEach items="${listRole }" var="item" >
										<option value="${item.id}" <c:if test="${item.id == user.roleId}"> selected ="selected"</c:if>>${item.name }</option>
									</c:forEach>
								</select>
							</div>
                            <div class="form-group">
                                <label>Avatar</label>
                                <input type="text" name="avatar" value="${user.avatar }" class="form-control" placeholder="avatar" readonly="readonly"/>
                            </div>
                        </div>
                        <div class="col-12 mt-3">
                            <a class="btn btn-success" href="<%=request.getContextPath()%>/profile/edit">Chỉnh sửa</a>
                            <a class="btn btn-secondary" href="<%=request.getContextPath()%>/home">Quay lại</a>
                        </div>
                    </div>
                </form>
            </section>
