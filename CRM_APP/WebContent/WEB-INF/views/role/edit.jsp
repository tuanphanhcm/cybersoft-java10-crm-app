    ...
    <div class="d-flex justify-content-between">
       ...
       <div id="side-bar">
        ...
        <div id="admin-wrapper">
            ...
            <!-- CONTENT -->
            <%
            	//Role role = (Role)request.getAttribute("roleOld");
            %>
            <section id="admin-content" class="p-3">
                <h3 class="mb-4 text-center">Chỉnh Sửa Thông Tin Quyền</h3>
                <p class="text-center text-danger">${message_update }</p>
                <form method="post" action="<%=request.getContextPath()%>/role/edit?">
                    <div class="row">
                        <div class="col-md-6 m-auto">
                        <input type="hidden" name="id" value="${roleOld.id }">
                            <div class="form-group">
                                <label>Tên quyền</label>
                                <input type="text" name="rolename" value="${roleOld.name }" class="form-control" placeholder="name" />
                            </div>
                            <div class="form-group">
                                <label>Mô tả</label>
                                <input type="text" name="description" value="${roleOld.description }" class="form-control" placeholder="description" />
                            </div>
                            <div class="form-group">
